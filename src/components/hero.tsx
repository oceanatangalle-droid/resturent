      ...
      >
        ...
        <div className="space-y-6">
          ...
          <p className="max-w-xl text-sm leading-relaxed text-veloria-muted md:text-base">
            Step into Veloria, a warm corner of New York where refined flavors,
            candlelight, and curated playlists set the stage for evenings you
        ...
        <div className="flex flex-wrap items-center gap-5 text-xs text-veloria-muted">
          ...
          <div>
            ...
            <p className="text-veloria-muted">
              Breakfast 7 – 11 AM • Lunch 12 – 3 PM • Dinner 6 – 11 PM
            </p>
          </div>
        </div>
      </motion.div>
          ...
          <div className="relative flex flex-col gap-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-veloria-cream">
                  A New York classic for over 40 years.
                </p>
              </div>
              <div className="veloria-badge px-3 py-2 text-right text-[0.7rem] leading-tight">
                <p className="uppercase tracking-[0.22em]">Michelin-level</p>
            ...
            <div className="mt-3 flex flex-col gap-3 rounded-2xl border border-veloria-border bg-veloria-black/60 p-4">
              ...
              <div className="space-y-2 text-xs text-veloria-cream/90">
                <div className="flex items-center justify-between gap-3">
                  <span>Black Truffle Risotto</span>
                  <span className="text-veloria-muted">$29</span>
                </div>
                <div className="flex items-center justify-between gap-3">
                  <span>Herb-Crusted Salmon</span>
                  <span className="text-veloria-muted">$20</span>
                </div>
                <div className="flex items-center justify-between gap-3">
                  <span>Wagyu Beef Burger</span>
                  <span className="text-veloria-muted">$18</span>
                </div>
              </div>
            </div>

            <div className="mt-2 flex items-center justify-between text-[0.7rem] text-veloria-muted">
              <p>Walk-ins welcome • Limited terrace seating</p>
              <p className="text-veloria-gold-soft">NYC • EST. 1980</p>
            </div>
          </div>
        </div>
      </motion.div>
